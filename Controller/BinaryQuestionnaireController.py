...
class BinaryQuestionnaireController:
    ...
    def generate_random(self):
        try:
            ...
            QMessageBox.warning(self.view, "Generate Random Data", f"Error: {e}")
    ...
    def tangles(self):
        try: 
            ...
            QMessageBox.warning(self.view, "Generate Tangles", f"Error: {e}")
    ...
    def dbscan(self):
        try:
            ...
            QMessageBox.warning(self.view, "Generate DBSCAN", f"Error: {e}")
    ...
    def kmeans(self):
        try: 
            ...
            QMessageBox.warning(self.view, "Generate Kmeans", f"Error: {e}")
    ...
    def export_groundtruth(self):
        ...
        try: 
            ...
            if fileName:
                print("Saving data to:", fileName)
                export_to_csv_groundtruth(self.view.generated_data.ground_truth, fileName + ".csv")
        except Exception as e:
            QMessageBox.warning(self.view, "Export Data", f"Error: {e}")